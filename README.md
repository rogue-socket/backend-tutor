# backend-tutor — `cc-windows` branch

> **Branch:** Windows + Claude Code. For other (OS × harness) combos, switch to [`main`](https://github.com/rogue-socket/backend-tutor/tree/main) (universal) or one of the other platform branches.
...
See [`INSTALL.md`](INSTALL.md) — Windows + Claude Code (PowerShell directory junction, no admin / Developer Mode required).
