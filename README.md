# backend-tutor — `codex-macos` branch

> **Branch:** macOS / Linux + Codex CLI. For other (OS × harness) combos, switch to [`main`](https://github.com/rogue-socket/backend-tutor/tree/main) (universal) or one of the other platform branches.
...
See [`INSTALL.md`](INSTALL.md) — macOS / Linux + Codex CLI. No symlink step; Codex reads `AGENTS.md` from the cloned repo's working directory.
